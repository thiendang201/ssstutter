...
const ProductDetails = () => {
  ...
  return (
    <div className="md:grid md:grid-cols-3 md:grid-rows-4 pb-[2rem]">
      <div>
        <ul className="w-[100vw] flex overflow-x-auto snap-x snap-mandatory ">
          {variant?.images &&
            variant.images.map(({ id, url }) => (
              <li
                key={id}
                className="snap-start pt-[125%] min-w-[100vw] bg-center bg-no-repeat bg-cover"
                style={{ backgroundImage: `url(${url})` }}
              ></li>
            ))}
        </ul>
      </div>
      <div className="lg:col-end-4 lg:row-start-1 md:h-[100%] px-[2rem]">
        <div className="flex justify-between items-baseline pt-[1.4rem]">
      ...
      <div className="lg:col-end-3 lg:col-span-2 mt-[3rem] px-[2rem]">
